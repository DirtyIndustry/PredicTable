<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alerttable.aspx.cs" Inherits="PredicTable.alerttable" %>
    ...
    <form id="form1" runat="server">
        <div class="bodywrapper">
            ...
            <div id="contentwrapper" class="contentwrapper">
                ...
                预警报发布时间：<input id="l6" style="z-index: 1000" class="easyui-datebox" editable="false" data-options="formatter:myformatter,parser:myparser"></input>
                ...
                <%--<div runat ="server"  id="OperationWord" style="height:900px;display:none">--%>
                <div runat="server" id="OperationWord" style="height: 900px">
