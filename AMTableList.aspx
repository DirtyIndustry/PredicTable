<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AMTableList.aspx.cs" Inherits="PredicTable.AMTableList" %>
...
<head runat="server">
    ...
    <script>
       var cx_arry = new Array("2", "27", "4", "28", "33","36" ,"38","51");
       var sw_arry = new Array("1", "3","37","50");
       var fl_arry = new Array("1", "27","3", "28", "33","37","39","50","52");
...
<body>
            ...
            <div id="contentwrapper" class="contentwrapper">
                ...
                <div style="margin-top: 0px">
                    ...
                    <div style="font-size: 15px; font-weight: bold">
                        ...
                        <input type="button" id="ReleasetableAll" onclick="All_Releasetable()" class="stdbtn" value="发布上午表单" />
                        <%-- <input type="button" id ="btn_check " onclick=" check()" class="stdbtn" value="查看预报单" />--%>
                        <br />
                    </div>
                </div>
                
                <!--表单01.72小时渤海海区及黄河海港风、浪预报  /上午一 -->
                <div class="dlgs" id="ddlg_01" style="height: 390px; padding: 10px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                <th id="ddlg_01title" class="head0" colspan="7">上午一、72小时渤海海区及黄河海港风、浪预报</th>
                            </tr>
                            <tr>
                        ...
                        <tbody id="ddlg_01_tbody" style="text-align: center">
                            <tr>
                                ...
                                <td>
                                    <input id="BH_BG_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_BX_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FX_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FL_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_SW_01" type="text" maxlength="20" style="visibility:hidden;" /></td>
                            </tr>
                            <tr>
                                <td class="SJ_02">*月*号</td>
                                <td>
                                    <input id="BH_BG_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_BX_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FX_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FL_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_SW_02" type="text" maxlength="20" style="visibility:hidden;"/></td>
                            </tr>
                            <tr>
                                <td class="SJ_03">*月*号</td>
                                <td>
                                    <input id="BH_BG_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_BX_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FX_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_FL_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="BH_SW_03" type="text" maxlength="20" style="visibility:hidden;"/></td>
                            </tr>
                            <tr>
                                <td rowspan="3">黄河海港</td>
                                <td class="SJ_01">*月*号</td>
                                <td>
                                    <input id="HHHG_BG_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_BX_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FX_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FL_01" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_SW_01" type="text" maxlength="20" /></td>

                            </tr>
                            <tr>
                                <td class="SJ_02">*月*号</td>
                                <td>
                                    <input id="HHHG_BG_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_BX_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FX_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FL_02" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_SW_02" type="text" maxlength="20" /></td>
                            </tr>
                            <tr>
                                <td class="SJ_03">*月*号</td>
                                <td>
                                    <input id="HHHG_BG_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_BX_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FX_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_FL_03" type="text" maxlength="20" /></td>
                                <td>
                                    <input id="HHHG_SW_03" type="text" maxlength="20" /></td>
                            </tr>
                ...
                <!--表单02.72小时港口潮位预报 /上午二 -->
                <div class="dlgs" id="ddlg_02" style="height: 430px; padding: 10px;">
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        <colgroup>
                            <col class="con0" />
                            <col class="con0" />
                        ...
                        <thead>
                            ...
                            <tr>
                                <th class="head1" colspan="10">上午二、72小时港口潮位预报</th>
                            </tr>
                ...
                <!--表单03.3天海洋水文气象预报综述 /上午三 -->
                <div class="dlgs" id="ddlg_27" style="height: auto; padding: 10px;">
                    <div style="border: 1px solid #ddd; width: auto; line-height: 36px; font-weight: bold; text-align: center;">上午三、3天海洋水文气象预报综述</div>
                    <div style="border: 1px solid #ddd; background-color: #d2ffe7;">
                        海浪：<textarea name="txt_SWQX_ZS_3HOURS" style="margin: 10px 10px 10px 10px; width: 90%; height: 20px; font-size: 18px; font-weight: 500;" id="SWQX_ZS_3DAYS"></textarea>
                    </div>
                    <div style="border: 1px solid #ddd; background-color: #d2ffe7;">
                        潮汐：<textarea name="txt_CXQX_ZS_3HOURS" style="margin: 10px 10px 10px 10px; width: 90%; height: 20px; font-size: 18px; font-weight: 500;" id="CXQX_ZS_3DAYS"></textarea>
                    </div>
                    <input style="float: right; margin: 3px 5px 0px 0px" type="button" class="stdbtn" onclick="dlgclose(27)" value="取消" />
                    <input style="float: right; margin: 3px 5px 0px 0px" type="button" class="stdbtn" onclick="dlg_Submit(27)" value="提交" />

                </div>

                <!--表单06.24小时水文气象预报综述 /上午四 -->
                <div class="dlgs" id="ddlg_28" style="height: auto; padding: 10px;">
                    <div style="border: 1px solid #ddd; width: auto; line-height: 36px; font-weight: bold; text-align: center; background-color: #d2ffe7;">上午四、24小时水文气象预报综述</div>
                    <div style="border: 1px solid #ddd; background-color: #d2ffe7;">
                ...
                <!--表单04.预计未来24小时海浪、水温预报 /上午五 -->
                <div class="dlgs" id="ddlg_03" style="height: 460px; padding: 10px; width: auto;">

                    <table style="border: 1px solid #ddd; width: 100%;">
                        <tr style="line-height: 45px;">
                            <td style="border-bottom: 1px solid #ddd; font-weight: bold; text-align: center" colspan="7">上午五、预计未来24小时海浪、水温预报</td>
                        </tr>
                        ...
                        <tr style="line-height: 45px">
                            ...
                            <td colspan="2">到
                                <input maxlength="20" id="BH_GDE_01" onkeyup="if(isNaN(value))execCommand('undo')" onblur="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" type="text" style="width: 80%" />m</td>
                        ...
                        <tr style="line-height: 45px">
                            ...
                            <td colspan="2">到
                                <input maxlength="20" id="HHBB_GDE_01" onkeyup="if(isNaN(value))execCommand('undo')" onblur="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" type="text" style="width: 80%" />m</td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="head1" colspan="10">上午六、24小时潮位预报</th>
                            </tr>
                ...
                <div class="dlgs" id="ddlg_39" style="height: 390px; padding: 10px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                <th id="ddlg_34title" class="head0" colspan="7">上午七、海上丝绸之路三天海浪、气象预报</th>
                            </tr>
                            <tr>
                                <th class="head0">区域</th>
                                <th class="head1">日期</th>
                ...
                <div class="dlgs" id="ddlg_38" style="height: 430px; padding: 10px;">
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th class="head1" colspan="10">上午八、海上丝绸之路三天潮汐预报</th>
                            </tr>
                ...
                <!--注掉不用 表单36.潍坊港24小时潮汐预报  已取消数据取上午八潍坊港24小时预报180710 edit by yuy-->
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable" style="text-align: center">
                        ...
                        <thead>
                            <tr style="text-align: center">
                                <th class="head0" colspan="4">上午九、潍坊港24小时潮汐预报</th>
                            </tr>
                ...
                <!--海区24小时海浪、水温预报  /原上午十 现在 上午九 180710 -->
                <div class="dlgs" id="ddlg_37" style="width: auto; height: 425px; padding: 10px;">
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable" style="text-align: center">
                        ...
                        <thead>
                            <tr style="text-align: center">
                                ...
                                <th class="head0" colspan="6">上午九、海区24小时海浪、水温预报</th>
                 ...
                 <!--表单50.海阳海浪、水温预报 /原上午十一 现在上午十 180710-->
                <div class="dlgs" id="ddlg_50">

                    <table style="border: 1px solid #ddd; width: 100%;">
                        <tr style="line-height: 45px;">
                            <td style="border-bottom: 1px solid #ddd; font-weight: bold; text-align: center" colspan="7">上午十、海阳海浪、水温预报</td>
                        </tr>
                        <tr style="line-height: 45px; display: none;">
                            <td></td>
                            <td></td>
                ...
                <!--表单51.海阳近岸海域潮汐预报 /原上午十二 现在上午十一 180710 -->
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="head1" colspan="10">上午十一、海阳近岸海域潮汐预报</th>
                            </tr>
                ...
                <!--表单52.海阳万米海滩海水浴场风、浪预报 /原上午十三 现在上午十二 180710 -->
                <div class="dlgs" id="ddlg_52"  style="margin: 10px 0px 10px 0px;width:auto;height: 200px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                <th class="head0" colspan="7">上午十二、海阳万米海滩海水浴场风、浪预报</th>
                            </tr>
                            <tr>
    ...
    <script>
        ...
        function All_Releasetable() {
            ...
            var strlist = "";
            if (week == 1) {
                //  strlist = "5号预报单（a4）,6号预报单（a4）,7号海洋水温海冰预报,24号东营专项预报,海上丝绸之路预报"; //生成文件中含有周报
            }
            else {
                strlist = "4号预报单(a4)-2014,20号潍坊市海洋预报台专项预报(10时),24号东营专项预报,26号预报单,海上丝绸之路预报,海阳近岸专项预报单";//生成文件中不含周报
            }
        ...
        function dlg_Submit(id) {//（无当天数据保存、有当天数据修改）↓
            switch (id) {
                case 1: submit_1(id); break;//表单1提交上午一、72小时渤海海区及黄河海港风、浪预报
                case 2: submit_2(id); break;//表单2提交上午二、72小时港口潮位预报
                case 3: submit_3(id); break;//表单3提交上午五、预计未来24小时海浪、水温预报
                case 4: submit_4(id); break;//表单4提交上午六、24小时潮位预报
              ...
              //  case 26: submit_26(id); break;//表单26提交
                ...
                case 27: submit_27(id); break;//上午三、3天海洋水文气象预报综述
                case 28: submit_28(id); break;//上午四、24小时水文气象预报综述
              ...
              //  case 32: submit_32(id); break;//十二、东营胜利油田专项海温周报
                //case 33: submit_33(id); break;//十三、黄河海港附近海域风、浪预报
                //case 34: submit_34(id); break;//十三、72小时东营神仙沟挡潮闸专项预报
                
                //case 36: submit_36(id); break;//上午九、潍坊港24小时潮汐预报  已取消数据取上午八潍坊港24小时预报180710 edit by yuy

                case 37: submit_37(id); break;//上午十、海区24小时海浪、水温预报

                case 39: submit_39(id); break;//上午七、海上丝绸之路三天海浪、气象预报
                case 38: submit_38(id); break;//上午八、海上丝绸之路三天潮汐预报
                case 50: submit_50(id); break;//上午十一、海阳海浪、水温预报
                case 51: submit_51(id); break;//上午十二、海阳近岸海域潮汐预报
                case 52: submit_52(id); break;//上午十三、海阳万米海滩海水浴场风、浪预报
                default:
            }
        }
        ...
        function alldlg_Submit() {//（无当天数据保存、有当天数据修改）↓
            submit_1(1); //上午一、72小时渤海海区及黄河海港风、浪预报
            submit_2(2); //上午二、72小时港口潮位预报
            submit_3(3); //上午五、预计未来24小时海浪、水温预报
            submit_4(4); //上午六、24小时潮位预报
            //submit_5(5); //表单5提交
            //  submit_6(6); //表单6提交
            //submit_7(7); //表单7提交
            //submit_8(8); //表单8提交
            ...
            // submit_25(25); //表单25提交
            //submit_26(26); //表单26提交
            submit_27(27); //上午三、3天海洋水文气象预报综述
            submit_28(28); //上午四、24小时水文气象预报综述
            // submit_29(29); //七、7天渤海海区及黄河海港风、浪预报
            //  submit_30(30); //八、7天海洋水文气象预报综述
            // submit_31(31); //九、7天港口潮位预报
            // submit_32(32); //十二、东营胜利油田专项海温周报
            //submit_36(36);//上午九、潍坊港24小时潮汐预报  已取消数据取上午八潍坊港24小时预报180710 edit by yuy
            submit_37(37);//上午十、海区24小时海浪、水温预报
            submit_39(39);//上午七、海上丝绸之路三天海浪、气象预报
            submit_38(38);//上午八、海上丝绸之路三天潮汐预报
            //submit_33(33); 
            //submit_34(34); 
            submit_50(50);//上午十一、海阳海浪、水温预报
            submit_51(51);//上午十二、海阳近岸海域潮汐预报
            submit_52(52);//上午十三、海阳万米海滩海水浴场风、浪预报
        }
        ...
        { //表单01
            ...
            function submit_23(id) {
                ...
                str_data += $("#Tel").val() + ",";//电话也不需要了
                // str_data += $("#Fabushijian").val() + ",";
                str_data += $("#Chuanzhen").val() + ",";//传值现在不需要了
        ...
        function gettabledata(date1, searchType) { //searchType 按填报日期还是预报日期查询 p:填报日期 f:预报日期
            ...
            $.ajax({//综合
                type: "POST",
                url: "/Ajax/gettablelist.ashx?method=getbydata&date=" + dates + "&searchtype=" + searchType+"&t="+Math.random(),
                cache:false,
                beforeSend: function () {
                    $('#w').window('open');
                ...
                success: function (result) {
                    ...
                    for (var j = 0; j < resjson.length; j++) {
                        switch (resjson[j].type) {
                            case "t1": gettable01(resjson[j], date1); dlgclose("1"); break;
                           ...
                           // case "t16": gettable16(resjson[j].children, date1); dlgclose("16"); break; 上午九、潍坊港24小时潮汐预报 取消不用合并到上午八潍坊港24小时 100710 edit by yuy
                           ...
                           // case "t29": gettable29(resjson[j].children, date1); dlgclose("29"); break;
                            //据获取7天海洋水文气象预报综述
                          ...
                          //  case "t31": gettable31(resjson[j].children, date1); dlgclose("31"); break;
                            ...
                            //case "t34": gettable34(resjson[j].children, date1); dlgclose("34"); break;
                             case "t36": gettable36(resjson[j].children, date1); dlgclose("36"); break;
        ...
        //ajax 各表数据赋值
        {
            //表单01数据 上午一、72小时渤海海区及黄河海港风、浪预报
            function gettable01(result, date1) {
                ...
                if (pbtypes == "bys") {
                    ...
                    for (var j = 0; j < windwaveForecast.length; j++) {
                        if (windwaveForecast[j].FORECASTAREA == "渤海") {
                            $("#BH_BG_01").val(windwaveForecast[j].WAVE24FORECAST);
                            $("#BH_BX_01").val(windwaveForecast[j].WINDDIRECTION24FORECAST);
                            $("#BH_FX_01").val(windwaveForecast[j].WINDDIRECTION24FORECAST);
                            $("#BH_FL_01").val(windwaveForecast[j].WINDFORCE24FORECAST);

                            $("#BH_BG_02").val(windwaveForecast[j].WAVE48FORECAST);
                            $("#BH_BX_02").val(windwaveForecast[j].WINDDIRECTION48FORECAST);
                            $("#BH_FX_02").val(windwaveForecast[j].WINDDIRECTION48FORECAST);
                            $("#BH_FL_02").val(windwaveForecast[j].WINDFORCE48FORECAST);

                            $("#BH_BG_03").val(windwaveForecast[j].WAVE72FORECAST);
                            $("#BH_BX_03").val(windwaveForecast[j].WINDDIRECTION72FORECAST);
                            $("#BH_FX_03").val(windwaveForecast[j].WINDDIRECTION72FORECAST);
                            $("#BH_FL_03").val(windwaveForecast[j].WINDFORCE72FORECAST);
                        }
                        else if (windwaveForecast[j].FORECASTAREA == "黄河海港") {
                            $("#HHHG_BG_01").val(windwaveForecast[j].WAVE24FORECAST);
                            $("#HHHG_BX_01").val(windwaveForecast[j].WINDDIRECTION24FORECAST);
                            $("#HHHG_FX_01").val(windwaveForecast[j].WINDDIRECTION24FORECAST);
                            $("#HHHG_FL_01").val(windwaveForecast[j].WINDFORCE24FORECAST);

                            $("#HHHG_BG_02").val(windwaveForecast[j].WAVE48FORECAST);
                            $("#HHHG_BX_02").val(windwaveForecast[j].WINDDIRECTION48FORECAST);
                            $("#HHHG_FX_02").val(windwaveForecast[j].WINDDIRECTION48FORECAST);
                            $("#HHHG_FL_02").val(windwaveForecast[j].WINDFORCE48FORECAST);

                            $("#HHHG_BG_03").val(windwaveForecast[j].WAVE72FORECAST);
                            $("#HHHG_BX_03").val(windwaveForecast[j].WINDDIRECTION72FORECAST);
                            $("#HHHG_FX_03").val(windwaveForecast[j].WINDDIRECTION72FORECAST);
                            $("#HHHG_FL_03").val(windwaveForecast[j].WINDFORCE72FORECAST);
                        }
                    }

                    var sw = result.sw;
                    for (var k = 0; k < sw.length; k++) {
                        //if (sw[k].REPORTAREA == "渤海") {
                        //    date = new Date(sw[k].FORECASTDATE);
                        //    num = parseInt(Math.abs(date - date1) / 1000 / 60 / 60 / 24) + 1;
                        //    $("#BH_SW_0" + num).val(sw[k].YRBHWWFWATERTEMPERATURE);
                        //}
                        //else
                        if (sw[k].NAME == "黄河海港") {
                            //date = new Date(sw[k].FORECASTDATE);
                            //num = parseInt(Math.abs(date - date1) / 1000 / 60 / 60 / 24) + 1;
                            //$("#HHHG_SW_0" + num).val(sw[k].YRBHWWFWATERTEMPERATURE);
                            $("#HHHG_SW_01").val(sw[k].MEAN_24H);
                            $("#HHHG_SW_02").val(sw[k].MEAN_48H);
                            $("#HHHG_SW_03").val(sw[k].MEAN_72H);
                        }
                    }
                }
            ...
            //表单16数据  上午九、潍坊港24小时潮汐预报 取消不用合并到上午八潍坊港24小时 100710 edit by yuy
            ...
            //上午八、海上丝绸之路三天潮汐预报
            function gettable38(resjson, date1) {//LKG_01G_SJ_01
                for (var i = 0; i < resjson.length; i++) {
                    if (resjson[i].qy == "青岛港") {
