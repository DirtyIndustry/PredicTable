...
namespace PredicTable.Dal
{
    public class sql_ReportMonthOrDays
    {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public int InsertReportMonthOrDays(ReportMonthModel month, string tableInfo, string reportType)
        //public int InsertReportMonthOrDays(ReportMonthModel month,  string reportType)
        {
            try
            {
                var sql = "INSERT INTO HT_REPORTMONTH(PUBLISHTIME,PUBLISHCOMPANY,REPORTNO,REPORTTITLE,REPORTNORTH,REPORTSOUTH,REPORTCONTENT,HEADREPORTER,DEPUTYREPORTER,DOCNAME,SENDDEPARTMENT,REPORTTYPE,SEAICE) "
                    + " VALUES "
                    ...
                    + " '" + month.HEADREPORTER + "','" + month.DEPUTYREPORTER + "','" + month.DOCNAME + "','" + month.SENDDEPARTMENT + "','"+ reportType + "','"+ tableInfo + "')";
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public int UpdateReportMonthOrDays(ReportMonthModel month, string tableInfo, string reportType)
        {
            try
            {
                var sql = "UPDATE HT_REPORTMONTH SET "
                    ...
                    + " SENDDEPARTMENT='" + month.SENDDEPARTMENT + "',SEAICE='"+tableInfo+"'"
