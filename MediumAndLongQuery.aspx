<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediumAndLongQuery.aspx.cs" Inherits="PredicTable.MediumAndLongQuery" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table id="dg" title="中长期预报单查询" class="easyui-datagrid" style="width: 100%; min-height: 700px; height: 100%" url="/Ajax/MediumAndLongQuery.ashx?method=getdata" toolbar="#toolbar" pagination="true" rownumbers="true" fitcolumns="true" singleselect="true">
            <thead>
                <tr>
    ...
    <div id="dlg_show" onload="" class="easyui-dialog" title="模板预览" data-options="iconCls:'icon-save'" style="width: 1067px; ">
        ...
        <div runat="server" id="Div1" style="height: 760px">
        ...
        function searchs() {
            ...
            $('#dg').datagrid({
                url: '/Ajax/MediumAndLongQuery.ashx?method=getbywhere'
            });
            //重新加载datagrid的数据  
            //   $("#dg").datagrid('reload');
        }
