    ...
    private void ThreeWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                three.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
    ...
    private void FourWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                Four.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间             
                //入库     
    ...
    private void SevenWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                seven.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间  
    ...
    private void TenWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                ten.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间     
    ...
    private void NineWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                nine.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间   
    ...
    private void ElevenWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                eleven.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间     
    ...
    private void TwelveWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                twelve.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间  
    ...
    private void FourteenWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                fourteen.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间 
    ...
    private void FifteenWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                fifteen.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间   
    ...
    private void TwentyWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                twenty.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间   
    ...
    private void TwentyfourWord()
    {
        try
        {
            ...
            if (list.Count == 1)
            {
                ...
                twentyfour.ExportWord(templateFile, fileName);
                //判断数据库是不是有当前预报单
                DateTime dt = DateTime.Now;//前台当前预报时间    
    ...
    {              
        ...
        if (tblybddocument.Rows.Count != 0)
        {
            ...
            if (a.Count>0)
            {
                ...
                updateword.updateword(fileName, dt);
            }
            else 
                {                  
                    //存入数据库
                    InsertWord insertword = new InsertWord();
                    insertword.saveword(fileName, dt);
                }
