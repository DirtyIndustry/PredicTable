...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.hello = exports.YBTide = exports.Http = exports.Async = undefined;
	...
	var Async = exports.Async = function ($exports) {
	  var AwaitDomEvent = $exports.AwaitDomEvent = function (el, event) {
	    return _fableCore.Async.fromContinuations(function (tupledArg) {
	      var cont = tupledArg[0];
	      var _arg1 = tupledArg[1];
	      var _arg2 = tupledArg[2];
	      var matchValue = _arg1;
	      var matchValue_1 = _arg2;
	
	      var listener = function (delegateArg0) {
	        delegateArg0;
	      };
	...
	var Http = exports.Http = function ($exports) {
	  var Request = $exports.Request = function (meth, url, data) {
	    return _fableCore.Async.fromContinuations(function (tupledArg) {
	      var cont = tupledArg[0];
	      ...
	      xhr.onreadystatechange = function (_arg1) {
	        return (xhr.readyState > 3 ? xhr.status === 200 : false) ? cont(xhr.responseText) : null, {};
	      };
	...
	var YBTide = exports.YBTide = function YBTide($arg0, $arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7, $arg8, $arg9, $arg10, $arg11, $arg12, $arg13, $arg14, $arg15, $arg16, $arg17, $arg18, $arg19, $arg20, $arg21, $arg22, $arg23, $arg24, $arg25, $arg26, $arg27, $arg28, $arg29, $arg30, $arg31, $arg32, $arg33) {
	  _classCallCheck(this, YBTide);
	
	  this.STATION = $arg0;
	  this.PREDICTIONDATE = $arg1;
	  this.H0 = $arg2;
	  this.H1 = $arg3;
	  this.H2 = $arg4;
	  this.H3 = $arg5;
	  ...
	  this.H22 = $arg24;
	  this.H23 = $arg25;
	  this.FSTHIGHWIDETIME = $arg26;
	  this.FSTHIGHWIDEHEIGHT = $arg27;
	  this.FSTLOWWIDETIME = $arg28;
	  this.FSTLOWWIDEHEIGHT = $arg29;
	  this.SCDHIGHWIDETIME = $arg30;
	  this.SCDHIGHWIDEHEIGHT = $arg31;
	  this.SCDLOWWIDETIME = $arg32;
	  this.SCDLOWWIDEHEIGHT = $arg33;
	};
	
	_fableCore.Util.setInterfaces(YBTide.prototype, [], "Code.YBTide");
	
	var hello = exports.hello = function () {
	  return function (builder_) {
	    return builder_.delay(function (unitVar) {
	      return builder_.bind(Http.Request("get", "Ajax/GetTideData.ashx?stations='101wmt'&dayCount=1"), function (_arg1) {
	        var res, tides, tide;
	        return res = _arg1, tides = JSON.parse(res), tide = tides[0], window.alert(tide.STATION), builder_.zero();
	      });
	    });
	  }(_fableCore.Async);
	};
