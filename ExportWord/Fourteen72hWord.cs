...
{
    public class Fourteen72hWord
    {
        public Fourteen72hWord()
        {
        ...
        public int ExportWord(string templateFile, string fileName, DateTime dt)
        {
            ...
            try
            {
                ...
                //为了方便管理声明书签数组
                object[] BookMark = new object[62];//新增2个预报电话 60改为62
                //赋值书签名
                ...
                BookMark[60] = "FWAVEFORECASTERTEL";//海浪预报员电话
                BookMark[61] = "FWATERTEMPERATUREFORECASTERTEL";//海温预报员电话
                ...
                doc.Bookmarks.get_Item(ref BookMark[60]).Range.Text = tblfooter_Model.FWAVEFORECASTERTEL;
                doc.Bookmarks.get_Item(ref BookMark[61]).Range.Text = tblfooter_Model.FWATERTEMPERATUREFORECASTERTEL;
