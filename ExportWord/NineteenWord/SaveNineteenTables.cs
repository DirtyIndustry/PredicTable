...
{
    public class SaveNineteenTables
    {
        string filepath;
        ...
        public SaveNineteenTables(string filepaths)
        {
        ...
        public void assignmentPredict_aging()
        {
            ...
            if (str.ToLower().Contains("_7day_") || str.Contains("周"))
            {
                predict_aging = "007d";
            }
            else if (str.ToLower().Contains("_10day_") || str.Contains("旬"))
            {
                predict_aging = "010d";
            }
        ...
        public void assignment()
        {
            ...
            //chuanzhen = GetTel(i_chuanzhen, "No.");
        ...
        private string SetLinks(int index)
        {
            ...
            string links = "";
            if (strRemoveSpace.Contains("电话"))
            {
                links = strRemoveSpace.Substring(4, strRemoveSpace.IndexOf("电话") - 4);
            }
            else
                links = strRemoveSpace.Substring(4);
            return links;
        }
        ...
        {
            string str = doctext[index].ToString();
            if (str.ToUpper().Contains("NO"))
            {
                str = str.Substring(0,str.ToUpper().IndexOf("NO"));
            }
            if (str.Contains(":"))
            {
