<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadAlerttableword.aspx.cs" Inherits="PredicTable.UploadAlerttableword" %>
            ...
            <div id="contentwrapper" class="contentwrapper">
               <h3 id="contenttitle1">模板导入</h3>
                ...
                <div>
                    ...
                    <input runat="server" id="type" name="type" size="33" type="hidden" value="1" />
                ...
                <div>
                    ...
                    <div>
                        <table id="dg" title="模板管理" class="easyui-datagrid" style="width: 100%; min-height: 700px; height: 100%" url="/Ajax/UploadLongerWorddate.ashx?method=getall&type=1" toolbar="#toolbar" pagination="true" rownumbers="true" fitcolumns="true" singleselect="true">
                            <thead>
                                <tr>
                ...
                if (row) {
                    $.messager.confirm('提示', '确定要删除这个模板吗?', function (r) {
                        if (r) {
                            ...
                            $.ajax({//综合
                                type: "GET",
                                url: "/Ajax/UploadLongerWorddate.ashx?method=del&type=1&id=" + row.id,
