...
namespace PredicTable.Dal
{
    ...
    public class sql_ReportYear
    {
        ...
        public int InsertReportYear(ReportYearModel year)
        {
            try
            {
                var sql = "INSERT INTO ht_reportyear(PUBLISHTIME,PUBLISHCOMPANY,REPORTNO,REPORTTITLE,STORMSURGE,SEAWAVE,REDTIDE,GREENTIDE,TROPICALCYCLONE,HEADREPORTER,DEPUTYREPORTER,DOCNAME,SENDDEPARTMENT) "
                    + " VALUES "
                    + " ('" + year.PUBLISHTIME + "','" + year.PUBLISHCOMPANY + "','" + year.REPORTNO + "','" + year.REPORTTITLE + "','" + year.STORMSURGE + "','" + year.SEAWAVE + "','" + year.REDTIDE + "',"
                    + " '" + year.GREENTIDE + "','" + year.TROPICALCYCLONE + "','" + year.HEADREPORTER + "','" + year.DEPUTYREPORTER + "','" + year.DOCNAME + "','" + year.SENDDEPARTMENT + "')";
