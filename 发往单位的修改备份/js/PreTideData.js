...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Concurrency,Unchecked,Date,PreTideData,Client,alert,Arrays,Seq,Strings,Json,Provider,Id,JSON,Option,jQuery;
 Runtime.Define(Global,{
  PreTideData:{
   Client:{
    Main:Runtime.Field(function()
    {
     ...
     {
      var dayCount,a,copyOfStruct;
      dayCount=[3];
      copyOfStruct=Date.now();
      if(Unchecked.Equals((new Date(copyOfStruct)).getDay(),1))
       {
        dayCount[0]=7;
      ...
      {
       var x;
       x=Client.fetchTideData("'113lko','119hhg'",dayCount[0]);
       return Concurrency.Bind(x,function(_arg1)
       {
        var a1;
        if(_arg1.$==1)
        ...
        else
         {
          Arrays.iteri(function(i)
          {
           ...
           {
            return Client.procPortTideData(dayCount[0],i,tide);
           };
          },_arg1.$0);
          a1=Concurrency.Return(null);
         }
        ...
        {
         var x1;
         x1=Client.fetchTideData("'117xdh','118gud','119hhg','122fyt'",1);
         return Concurrency.Bind(x1,function(_arg2)
         {
          ...
          if(_arg2.$==1)
           ...
           {
            Arrays.iter(function(tide)
            {
             return Client.proc24TideData(tide);
            },_arg2.$0);
            a2=Concurrency.Return(null);
           }
          ...
          {
           var x2;
           x2=Client.fetchTideData("'101wmt','104rzh','109wh','111zfd','114wfg','119hhg','125bzg'",1);
           return Concurrency.Bind(x2,function(_arg3)
           {
            var a3;
            if(_arg3.$==1)
             {
              alert(_arg3.$0);
              a3=Concurrency.Return(null);
             }
            else
             {
              Arrays.iter(function(tide)
              {
               return Client.proc7City24TideData(tide);
              },_arg3.$0);
              a3=Concurrency.Return(null);
             }
            ...
            {
             var x3;
             x3=Client.fetchTideData("'101wmt'",1);
             return Concurrency.Bind(x3,function(_arg4)
             {
              var a4,matchValue;
              if(_arg4.$==1)
               {
                alert(_arg4.$0);
                a4=Concurrency.Return(null);
               }
              else
               {
                matchValue=Arrays.tryHead(_arg4.$0);
                if(matchValue.$==0)
                 {
                  a4=Concurrency.Return(null);
                 }
                 ...
                 {
                  Client.procQD24TideData(matchValue.$0);
                  a4=Concurrency.Return(null);
                 }
               }
              return Concurrency.Combine(a4,Concurrency.Delay(function()
              {
               var x4;
               x4=Client.fetchTideData("'117xdh'",3);
               return Concurrency.Bind(x4,function(_arg5)
               {
                var a5;
                if(_arg5.$==1)
                 {
                  alert(_arg5.$0);
                  a5=Concurrency.Return(null);
                 }
                else
                 {
                  Arrays.iteri(function(i)
                  {
                   return function(tide)
                   {
                    return Client.procTideData("MZZ",i,tide);
                   };
                  },_arg5.$0);
                  a5=Concurrency.Return(null);
                 }
                return Concurrency.Combine(a5,Concurrency.Delay(function()
                {
                 var x5;
                 x5=Client.fetchTideData("'128cfd'",3);
                 return Concurrency.Bind(x5,function(_arg6)
                 {
                  var a6;
                  if(_arg6.$==1)
                   {
                    alert(_arg6.$0);
                    a6=Concurrency.Return(null);
                   }
                  else
                   {
                    Arrays.iteri(function(i)
                    {
                     return function(tide)
                     {
                      return Client.procTideData("NBYT",i,tide);
                     };
                    },_arg6.$0);
                    a6=Concurrency.Return(null);
                   }
                  return Concurrency.Combine(a6,Concurrency.Delay(function()
                  {
                   var x6;
                   x6=Client.fetchTideData("'114wfg'",1);
                   return Concurrency.Bind(x6,function(_arg7)
                   {
                    var a7;
                    if(_arg7.$==1)
                     {
                      alert(_arg7.$0);
                      a7=Concurrency.Return(null);
                     }
                    else
                     {
                      Arrays.iter(function(tide)
                      {
                       return Client.proc24HsTideData("WFG",tide);
                      },_arg7.$0);
                      a7=Concurrency.Return(null);
                     }
                    return Concurrency.Combine(a7,Concurrency.Delay(function()
                    {
                     var x7;
                     x7=Client.fetchTideData("'102xmd'",1);
                     return Concurrency.Bind(x7,function(_arg8)
                     {
                      var a8,matchValue1;
                      if(_arg8.$==1)
                       {
                        alert(_arg8.$0);
                        a8=Concurrency.Return(null);
                       }
                      else
                       {
                        matchValue1=Arrays.tryHead(_arg8.$0);
                        if(matchValue1.$==0)
                         {
                          a8=Concurrency.Return(null);
                         }
                         ...
                         {
                          Client.procXMD24TideData(matchValue1.$0);
                          a8=Concurrency.Return(null);
                         }
                       }
                      return Concurrency.Combine(a8,Concurrency.Delay(function()
                      {
                       var x8;
                       x8=Client.fetchTideData("'101wmt'",2);
                       return Concurrency.Bind(x8,function(_arg9)
                       {
                        var _,matchValue2;
                        if(_arg9.$==1)
                         {
                         ...
                         {
                          matchValue2=Arrays.tryLast(_arg9.$0);
                          if(matchValue2.$==0)
                           {
                            _=Concurrency.Return(null);
                           }
                           ...
                           {
                            Client.procQD48TideData(matchValue2.$0);
                            _=Concurrency.Return(null);
                           }
                         }
                        return Concurrency.Combine(_,Concurrency.Delay(function()
                        {
                         return Concurrency.Bind(Client.fetchTideData("'105nhd','106wdn','107sdo','108cst','109wh'",2),function(_arg10)
                         {
                          if(_arg10.$==1)
                           {
                            alert(_arg10.$0);
                          ...
                          else
                           {
                            Arrays.iteri(function(i)
                            {
                             return function(tide)
                             {
                              return Client.procTideData2(i,tide);
                             };
                            },_arg10.$0);
                            return Concurrency.Return(null);
                           }
    ...
    apiCall:function(data)
    {
     ...
     arg00=function(tupledArg)
     {
      var ok,ko,_arg5,mapping,source,strings,parts,url,settings,action,option,value;
      ok=tupledArg[0];
      ko=tupledArg[1];
      _arg5=tupledArg[2];
      ...
      source=data.UrlParams;
      strings=Seq.map(mapping,source);
      parts=Strings.concat("&",strings);
      url=data.Url+"?"+parts;
      settings={
       type:data.Type,
       url:url,
       ...
       success:function(respData)
       {
        return ok({
         $:0,
         $0:data.OnSuccess.call(null,respData)
        });
       },
       error:function(xhr)
       {
        return ok({
         $:1,
         $0:((Provider.get_Default().DecodeRecord(undefined,[["Error",Id,0]]))())(JSON.parse(xhr.responseText)).Error
        });
       }
      };
      action=function(d)
    ...
    fetchTideData:function(stations,dayCount)
    {
     var urlParams,d,ons,data;
     urlParams=Seq.delay(function()
     {
      return Seq.append([["stations",stations]],Seq.delay(function()
      {
       return[["dayCount",Global.String(dayCount)]];
      }));
     });
     d={
      $:0
     ...
     data=Client.mkApiData("GET","Ajax/GetTideData.ashx",urlParams,d,ons);
     return Client.apiCall(data);
    },
    mkApiData:function(t,u,up,d,ons)
    {
     return{
      Type:t,
      Url:u,
    ...
    proc24HsTideData:function(stationCode,tide)
    {
     var s_GCCS_01,s_GCCG_01,s_DCCS_01,s_DCCG_01,s_GCCS_02,s_GCCG_02,s_DCCS_02,s_DCCG_02,value,value1,value2,value3,value4,value5,value6,value7;
     s_GCCS_01="#"+stationCode+"_GCCS_01";
     s_GCCG_01="#"+stationCode+"_GCCG_01";
     s_DCCS_01="#"+stationCode+"_DCCS_01";
     s_DCCG_01="#"+stationCode+"_DCCG_01";
     s_GCCS_02="#"+stationCode+"_GCCS_02";
     s_GCCG_02="#"+stationCode+"_GCCG_02";
     s_DCCS_02="#"+stationCode+"_DCCS_02";
     s_DCCG_02="#"+stationCode+"_DCCG_02";
     value=jQuery(s_GCCS_01).val(tide.FSTHIGHWIDETIME);
     value1=jQuery(s_GCCG_01).val(tide.FSTHIGHWIDEHEIGHT);
     value2=jQuery(s_DCCS_01).val(tide.FSTLOWWIDETIME);
     value3=jQuery(s_DCCG_01).val(tide.FSTLOWWIDEHEIGHT);
     value4=jQuery(s_GCCS_02).val(tide.SCDHIGHWIDETIME);
     value5=jQuery(s_GCCG_02).val(tide.SCDHIGHWIDEHEIGHT);
     value6=jQuery(s_DCCS_02).val(tide.SCDLOWWIDETIME);
     value7=jQuery(s_DCCG_02).val(tide.SCDLOWWIDEHEIGHT);
     return;
    },
    proc24TideData:function(tide)
    {
     var matchValue,stationName;
     matchValue=tide.STATION;
     stationName=matchValue==="117xdh"?"XDH":matchValue==="118gud"?"GD":matchValue==="119hhg"?"DYG":matchValue==="122fyt"?"FYT":"";
     return Client.procTideData(stationName,0,tide);
    },
    proc7City24TideData:function(tide)
    {
     var matchValue,stationName,s_01G_H,s_01G_MIN,s_01D_H,s_01D_MIN,s_02G_H,s_02G_MIN,s_02D_H,s_02D_MIN,fstHTime,fstLTime,scdHTime,scdLTime,_,arr,value,value1,_1,arr1,value2,value3,_2,arr2,value4,value5,_3,arr3,value6,value7;
     matchValue=tide.STATION;
     ...
     if(!(fstHTime.indexOf("-")!=-1))
      {
       arr=Strings.SplitChars(fstHTime,[58],1);
       value=jQuery(s_01G_H).val(Arrays.get(arr,0));
       value1=jQuery(s_01G_MIN).val(Arrays.get(arr,1));
       _=void value1;
      }
     else
      {
     ...
     if(!(fstLTime.indexOf("-")!=-1))
      {
       arr1=Strings.SplitChars(fstLTime,[58],1);
       value2=jQuery(s_01D_H).val(Arrays.get(arr1,0));
       value3=jQuery(s_01D_MIN).val(Arrays.get(arr1,1));
       _1=void value3;
      }
     else
      {
     ...
     if(!(scdHTime.indexOf("-")!=-1))
      {
       arr2=Strings.SplitChars(scdHTime,[58],1);
       value4=jQuery(s_02G_H).val(Arrays.get(arr2,0));
       value5=jQuery(s_02G_MIN).val(Arrays.get(arr2,1));
       _2=void value5;
      }
     else
      {
     ...
     if(!(scdLTime.indexOf("-")!=-1))
      {
       arr3=Strings.SplitChars(scdLTime,[58],1);
       value6=jQuery(s_02D_H).val(Arrays.get(arr3,0));
       value7=jQuery(s_02D_MIN).val(Arrays.get(arr3,1));
       _3=void value7;
      }
     else
      {
    ...
    procPortTideData:function(dayCount,i,tide)
    {
     var index,matchValue,portName;
     index=i;
     matchValue=tide.STATION;
     portName=matchValue==="113lko"?"LKG":matchValue==="119hhg"?"HHHG":"";
     portName==="HHHG"?index=index-dayCount:null;
     return Client.procTideData(portName,index,tide);
    },
    procQD24TideData:function(tide)
    {
     var fstHTime,fstLTime,scdHTime,scdLTime,_,arr,value,value1,value2,_1,arr1,value3,value4,value5,_2,arr2,value6,value7,value8,_3,arr3,value9,valuea,valueb;
     fstHTime=tide.FSTHIGHWIDETIME;
     fstLTime=tide.FSTLOWWIDETIME;
     scdHTime=tide.SCDHIGHWIDETIME;
     scdLTime=tide.SCDLOWWIDETIME;
     if(!(fstHTime.indexOf("-")!=-1))
      {
       arr=Strings.SplitChars(fstHTime,[58],1);
       value=jQuery("#01GC_H").val(Arrays.get(arr,0));
       value1=jQuery("#01GC_MIN").val(Arrays.get(arr,1));
       value2=jQuery("#01GC_CM").val(tide.FSTHIGHWIDEHEIGHT);
       _=void value2;
      }
     else
      {
     ...
     if(!(fstLTime.indexOf("-")!=-1))
      {
       arr1=Strings.SplitChars(fstLTime,[58],1);
       value3=jQuery("#01DC_H").val(Arrays.get(arr1,0));
       value4=jQuery("#01DC_MIN").val(Arrays.get(arr1,1));
       value5=jQuery("#01DC_CM").val(tide.FSTLOWWIDEHEIGHT);
       _1=void value5;
      }
     else
      {
     ...
     if(!(scdHTime.indexOf("-")!=-1))
      {
       arr2=Strings.SplitChars(scdHTime,[58],1);
       value6=jQuery("#02GC_H").val(Arrays.get(arr2,0));
       value7=jQuery("#02GC_MIN").val(Arrays.get(arr2,1));
       value8=jQuery("#02GC_CM").val(tide.SCDHIGHWIDEHEIGHT);
       _2=void value8;
      }
     else
      {
     ...
     if(!(scdLTime.indexOf("-")!=-1))
      {
       arr3=Strings.SplitChars(scdLTime,[58],1);
       value9=jQuery("#02DC_H").val(Arrays.get(arr3,0));
       valuea=jQuery("#02DC_MIN").val(Arrays.get(arr3,1));
       valueb=jQuery("#02DC_CM").val(tide.SCDLOWWIDEHEIGHT);
       _3=void valueb;
      }
     else
      {
    ...
    procQD48TideData:function(tide)
    {
     var fstHTime,fstLTime,scdHTime,scdLTime,_,arr,value,value1,value2,_1,arr1,value3,value4,value5,_2,arr2,value6,value7,value8,_3,arr3,value9,valuea,valueb;
     fstHTime=tide.FSTHIGHWIDETIME;
     fstLTime=tide.FSTLOWWIDETIME;
     ...
     if(!(fstHTime.indexOf("-")!=-1))
      {
       arr=Strings.SplitChars(fstHTime,[58],1);
       value=jQuery("#01GC_H20").val(Arrays.get(arr,0));
       value1=jQuery("#01GC_MIN20").val(Arrays.get(arr,1));
       value2=jQuery("#01GC_CM20").val(tide.FSTHIGHWIDEHEIGHT);
       _=void value2;
      }
     else
      {
     ...
     if(!(fstLTime.indexOf("-")!=-1))
      {
       arr1=Strings.SplitChars(fstLTime,[58],1);
       value3=jQuery("#01DC_H20").val(Arrays.get(arr1,0));
       value4=jQuery("#01DC_MIN20").val(Arrays.get(arr1,1));
       value5=jQuery("#01DC_CM20").val(tide.FSTLOWWIDEHEIGHT);
       _1=void value5;
      }
     else
      {
     ...
     if(!(scdHTime.indexOf("-")!=-1))
      {
       arr2=Strings.SplitChars(scdHTime,[58],1);
       value6=jQuery("#02GC_H20").val(Arrays.get(arr2,0));
       value7=jQuery("#02GC_MIN20").val(Arrays.get(arr2,1));
       value8=jQuery("#02GC_CM20").val(tide.SCDHIGHWIDEHEIGHT);
       _2=void value8;
      }
     else
      {
     ...
     if(!(scdLTime.indexOf("-")!=-1))
      {
       arr3=Strings.SplitChars(scdLTime,[58],1);
       value9=jQuery("#02DC_H20").val(Arrays.get(arr3,0));
       valuea=jQuery("#02DC_MIN20").val(Arrays.get(arr3,1));
       valueb=jQuery("#02DC_CM20").val(tide.SCDLOWWIDEHEIGHT);
       _3=void valueb;
      }
     else
      {
    ...
    procTideData:function(stationCode,i,tide)
    {
     var index,s_01G_SJ,s_01G_CW,s_01D_SJ,s_01D_CW,s_02G_SJ,s_02G_CW,s_02D_SJ,s_02D_CW,value,value1,value2,value3,value4,value5,value6,value7;
     index=i+1;
     s_01G_SJ="#"+stationCode+"_01G_SJ_0"+Global.String(index);
     s_01G_CW="#"+stationCode+"_01G_CW_0"+Global.String(index);
     s_01D_SJ="#"+stationCode+"_01D_SJ_0"+Global.String(index);
     s_01D_CW="#"+stationCode+"_01D_CW_0"+Global.String(index);
     s_02G_SJ="#"+stationCode+"_02G_SJ_0"+Global.String(index);
     s_02G_CW="#"+stationCode+"_02G_CW_0"+Global.String(index);
     s_02D_SJ="#"+stationCode+"_02D_SJ_0"+Global.String(index);
     s_02D_CW="#"+stationCode+"_02D_CW_0"+Global.String(index);
     value=jQuery(s_01G_SJ).val(tide.FSTHIGHWIDETIME);
     value1=jQuery(s_01G_CW).val(tide.FSTHIGHWIDEHEIGHT);
     value2=jQuery(s_01D_SJ).val(tide.FSTLOWWIDETIME);
     value3=jQuery(s_01D_CW).val(tide.FSTLOWWIDEHEIGHT);
     value4=jQuery(s_02G_SJ).val(tide.SCDHIGHWIDETIME);
     value5=jQuery(s_02G_CW).val(tide.SCDHIGHWIDEHEIGHT);
     value6=jQuery(s_02D_SJ).val(tide.SCDLOWWIDETIME);
     value7=jQuery(s_02D_CW).val(tide.SCDLOWWIDEHEIGHT);
     return;
    },
    procTideData2:function(i,tide)
    {
     var matchValue,stationName,index;
     matchValue=tide.STATION;
     stationName=matchValue==="105nhd"?"RS":matchValue==="106wdn"?"WD":matchValue==="107sdo"?"SD":matchValue==="108cst"?"CST":matchValue==="109wh"?"WH":"";
     index=i%2===0?0:1;
     return Client.procTideData(stationName,index,tide);
    },
    procXMD24TideData:function(tide)
    {
     var fstHTime,fstLTime,scdHTime,scdLTime,_,arr,value,value1,_1,arr1,value2,value3,_2,arr2,value4,value5,_3,arr3,value6,value7;
     fstHTime=tide.FSTHIGHWIDETIME;
     fstLTime=tide.FSTLOWWIDETIME;
     scdHTime=tide.SCDHIGHWIDETIME;
     scdLTime=tide.SCDLOWWIDETIME;
     if(!(fstHTime.indexOf("-")!=-1))
      {
       arr=Strings.SplitChars(fstHTime,[58],1);
       value=jQuery("#XMD_01GC_H").val(Arrays.get(arr,0));
       value1=jQuery("#XMD_01GC_MIN").val(Arrays.get(arr,1));
       _=void value1;
      }
     else
      {
     ...
     if(!(fstLTime.indexOf("-")!=-1))
      {
       arr1=Strings.SplitChars(fstLTime,[58],1);
       value2=jQuery("#XMD_01DC_H").val(Arrays.get(arr1,0));
       value3=jQuery("#XMD_01DC_MIN").val(Arrays.get(arr1,1));
       _1=void value3;
      }
     else
      {
     ...
     if(!(scdHTime.indexOf("-")!=-1))
      {
       arr2=Strings.SplitChars(scdHTime,[58],1);
       value4=jQuery("#XMD_02GC_H").val(Arrays.get(arr2,0));
       value5=jQuery("#XMD_02GC_MIN").val(Arrays.get(arr2,1));
       _2=void value5;
      }
     else
      {
     ...
     if(!(scdLTime.indexOf("-")!=-1))
      {
       arr3=Strings.SplitChars(scdLTime,[58],1);
       value6=jQuery("#XMD_02DC_H").val(Arrays.get(arr3,0));
       value7=jQuery("#XMD_02DC_MIN").val(Arrays.get(arr3,1));
       _3=void value7;
      }
     else
      {
 ...
 Runtime.OnInit(function()
 {
  ...
  Unchecked=Runtime.Safe(Global.WebSharper.Unchecked);
  Date=Runtime.Safe(Global.Date);
  PreTideData=Runtime.Safe(Global.PreTideData);
  Client=Runtime.Safe(PreTideData.Client);
