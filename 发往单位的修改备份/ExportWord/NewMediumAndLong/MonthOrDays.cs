...
namespace PredicTable.ExportWord.NewMediumAndLong
{
    ...
    public class MonthOrDays
    {
        ...
        /// <returns></returns>
        public int CopyWord(string templateFile, string fileName, ReportMonthModel month)
        {
            //生成word程序对象
        ...
        /// <returns></returns>
        private int SaveENMark(Word.Application app, string FileName, ReportMonthModel month)
        {
            //生成documnet对象
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        private int SaveCNMark(Word.Application app, string FileName, ReportMonthModel month)
        {
            //生成documnet对象
            Word.Document doc = new Word.Document();
            object Obj_FileName = FileName;
