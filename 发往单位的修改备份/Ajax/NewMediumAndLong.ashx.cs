    ...
    public class NewMediumAndLong : IHttpHandler
    {
        ...
        private void SetMonthOrXun(HttpContext context)
        {
            try
            {
                ...
                //以下是根据时间判断是旬，还是月 start
                //var reportType = "";//type形式为X,M
                //string ptime = context.Request.Form["PUBLISHTIME"].ToString();//表单选定的提交时间
                //string yue = ptime.Substring(4,2);
                //string ri = ptime.Substring(6,2);
                //if (ri == "09" || ri == "19" || ri == "29" || (yue == "02" && ri == "28"))
                //{
                //    reportType = "\"X\"";
                //}
                //else if(ri == "25" || ri == "26") {
