...
namespace PredicTable
{
    public partial class ForecastQuery : System.Web.UI.Page
    {
        ...
        protected void lbtnShow_Click(object sender, EventArgs e)
        {
            ...
            var dt = (DataTable)new sql_TableQuery().get_TableQuerybydata(rowId);
            byte[] showbyte;
            var fileName = "";
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                fileName = dt.Rows[0]["YBDNAME"].ToString();
        ...
        protected void lbtnDownLoad_Click(object sender, EventArgs e)
        {
            ...
            var dt = (DataTable)new sql_TableQuery().get_TableQuerybydata(FileId);
